...
When you move e.g. 100um in the positive direction of the axis and then move 100um back in the negative direction there will be a small offset (a few um), which is called backlash. It is a result of the tolerances of all the mechanical parts of the axis.

## How to check Axis Backlash

The Backlash should be well below 10um for each axis.
...
Now move back by 100um pressing the arrow of in the opposite direction.
In an ideal case the light blue cross hair will be centered on the structure of your choice again. In reality it will look something like this - a backlash on the order of 6-7um. The red arrow points to the center of the structure of choice (which was the starting point).
