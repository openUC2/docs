...
3. Open the "Networking" page using Cockpit's navigation sidebar.
4. In the "Firewall" page, click on the "Edit rules and zones" button.
5. If the port needs to be accessible over [direct connections to the machine](../day-1/connectivity/README.md#directly), add a firewalld service for the port in the "NetworkManager Shared" zone:
...
1. [Enter the machine's terminal](../day-1/sw-access/README.md#the-machines-terminal).
2. If the port needs to be accessible over [direct connections to the machine](../day-1/connectivity/README.md#directly), add a rule for the port in the "nm-shared" zone:
